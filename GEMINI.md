...
| **2026-09-10** | **00. 핀테크 시니어 코스 - Day 3** | • GC 심화 & 세대분리: 약한 세대 가설, Eden/Survivor/Old, STW와 P99 Tail Latency, Throughput vs Latency<br/>• 코딩테스트: Two Pointer (정렬된 Two Sum $O(N)$ / $O(1)$, 회문 Palindrome 검사 $O(N)$ / $O(1)$) |
